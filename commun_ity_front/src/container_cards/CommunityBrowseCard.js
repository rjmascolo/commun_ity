    ...
    return (
      <Item href={`/community/${this.props.id}`}>
        ...
        <Item.Content>
          ...
          <Item.Extra>
            {this.state.notJoined &&
            !(this.props.alreadyJoined || this.props.isManager) ? (
            ...
            <Label>
              <Icon name="group" /> {members} People Belong
            </Label>
          </Item.Extra>
        </Item.Content>
      </Item>
